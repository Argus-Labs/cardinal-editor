...
import { EntityCards, EntityList } from '@/components/cardinal/entity-views'
import { EditEntityGroupSheet } from '@/components/cardinal/sheets/edit-entity-group'
import { NewEntityGroupSheet } from '@/components/cardinal/sheets/new-entity-group'
...
export const Route = createFileRoute('/_cardinal/cardinal')({
  component: Cardinal,
})
